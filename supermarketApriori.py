#demonstrare of assosiation rule process on dataset supermarket.arff using appriori algorithm
import pandas as pd
from mlxtend.frequent_patterns import apriori
from mlxtend.frequent_patterns import association_rules

# Load the dataset
data = pd.read_csv(r"C:\Users\Srinivasa Rao\OneDrive\Documents\DM\super market.csv")
