#demonstration of classification ruleprocess on dataset employee.arff using id3 algorithm using python
import csv
import math
...
data = []
with open(r"C:\Users\Srinivasa Rao\OneDrive\Documents\DM\employeeid3.csv") as csvfile:
