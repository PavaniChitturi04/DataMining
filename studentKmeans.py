#demonstration of clustering rule process on data sets iris.arff and student.arff using simple kmeans
#student.arff
import pandas as pd
import numpy as np
...
# Load the ARFF data
data = arff.loadarff(r"C:\Users\Srinivasa Rao\OneDrive\Documents\DM\student1.arff")  # Replace "student.arff" with the actual file path
